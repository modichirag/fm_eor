...
class MockModel(base.MockModel):
    #model is relu[ b1*\delta + b2*\delta**2 - \delta_0]
    def __init__(self, dynamic_model, bias=[1., 0.], threshold=2.):
    ...
    def get_code(self):
        ...
        code.multiply(x1='final', x2='final', y='finalsq')
        code.multiply(x1='final', x2=Literal(self.bias[0]), y='b1final')
        code.multiply(x1='finalsq', x2=Literal(self.bias[1]), y='b2finalsq')
        code.add(x1='b1final', x2='b2finalsq', y='biased')
        code.add(x1='biased', x2=Literal(self.thresh), y='threshold')
        code.relu(x='threshold', y='model')
        return code
